          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-lg font-black italic uppercase tracking-tighter leading-none">STICK WAR</h1>
                  <p className="text-[10px] text-amber-500 font-bold tracking-widest uppercase">SAGA CHRONICLES</p>
                </div>
              </div>
